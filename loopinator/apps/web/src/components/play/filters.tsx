...
const SLOT_IS_OPERATORS = resolveChoiceOperators(["is"]);
const SLOT_CHOICE_FIELDS = makeFields(SLOT_IS_OPERATORS, SLOT_IS_OPERATORS);

export const SLOT_TIME_SIGNATURE_FIELDS = SLOT_CHOICE_FIELDS.filter(
